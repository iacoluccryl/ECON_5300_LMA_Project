...
summary(lm(log(tx_pop_df$PERSON_EARNINGS) ~ tx_pop_df$EDUCATIONAL_ATTAINMENT))

summary(lm(log(tx_pop_df$PERSON_EARNINGS) ~ tx_pop_df$EDUCATIONAL_ATTAINMENT + tx_pop_df$MARITAL_STATUS + tx_pop_df$SEX + tx_pop_df$AGEP))

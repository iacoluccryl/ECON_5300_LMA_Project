...
model_one <- lm(WAGE ~ (primary_education + ged_or_equivalent + some_college + associates + bachelors + 
                        masters + professional + doctorate + AGEP + AFRICAN_AMERICAN + AMERICAN_INDIAN + WHITE), data = tx_pop_df_spread_male)

bptesteq = lm(residuals(model_one) * residuals(model_one) ~ 

...
* AGEP
    ...
    + In our analysis we want individuals who are legally able to be fully employed. In Texas the minimum age for full employment is 14, however, by law that individual is still considered a child.
        ...
        + In this analysis we will want to analyze people who are not bound by hour age regulations by the state, so only people greater than 18 years old will be analyzed.
* Employment Status
...
* Person Earnings
    ...
    + In this analysis we may have to keep in mind that when individuals were filling out their income values that they may have rounded up or down.

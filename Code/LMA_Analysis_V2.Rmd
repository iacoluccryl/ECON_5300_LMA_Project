...
```{r, echo=FALSE}
model_one <- lm(log(WAGE) ~ primary_education + ged_or_equivalent + some_college + associates + bachelors + masters + professional + doctorate + AGEP + male, data = tx_pop_df_spread)

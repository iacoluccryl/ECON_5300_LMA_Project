...
Based on the above table, when holding all other variables constant, you can see that white females make on average 2.7% more than the reference variable, females of other races, and black females make 3.87% less. As expected, females with no schooling  and only primary school education make less than those with a GED. However, those with primary education make 23.78% less than those with a GED and no schooling makes 18.65% less. Females with some college, an associates degree, a bachelors degree, a master's degree, and a doctorate degree all make more than a female with a GED at an increasing rate. Compared to those with a GED, females with some college make 14.98% more, associates degrees; 26.40%, bachelor's degrees; 52.03% more, master's degree; 64.67% more, and doctorate degree; 82.01% more. We can see that for females, as greater educational attainment is achieved, earnings go up as well.  It is noteworthy to say that those with a professional degree make 94.79% more than those with a GED when holding all other variables constant. 
